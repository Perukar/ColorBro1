...
- Правило DAMAGE / POROSITY / ELASTICITY: знайдено. high damage/porosity не має давати automatic APPROVED; brittle блокує освітлення; warning-only не достатній для high-risk lift.
