...
| `test_www_structured_safety_flags.js` | Safety gates use structured `recipe.meta` flags (powder/SB/toning/grey/high-ox) not display text; robust to label rename; meta never rendered; user cannot inject meta (10 groups) |
