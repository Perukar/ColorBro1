...
| `test_www_structured_safety_flags.js` | Safety gates + advisory mixtone/timing use structured `recipe.meta` (powder/SB/toning/grey/high-ox) not display text; robust to label rename; meta never rendered; user cannot inject meta (15 groups) |
