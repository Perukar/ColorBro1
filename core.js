        ...
        if (isMidBand && isPowderBase) {
            ...
            if (finalLength && finalLength.process === "Емульгація") {
                ...
                phase1.steps.push({
                    ...
                    details: "Змити ШГО + Маска після досягнення ФО.<div class='tech-note'>🧼 ЕТАП ОЧИЩЕННЯ: Змити пудру ШГО (2 рази). Обов'язково нанести ліпідну маску на 5 хв для наповнення структури ПЕРЕД тонуванням.</div>",
            ...
            if (isCoolBlonde && inputSnapshot.condition === HairCondition.POROUS) {
                phase2.steps.push({
                    ...
                    details: "Нанести на вологе волосся. Візуальний контроль.<div class='tech-note'>⚡ Технологічна нота:<br>🎨 ФІКСАЦІЯ КОЛЬОРУ: Після тонування використовувати ТІЛЬКИ кондиціонер з низьким pH. Маску НЕ використовувати (вона вимиває пігмент).<br>🎨 ПОРАДА ДЛЯ СИВИНИ/.11: Якщо щільності попелу на сивині недостатньо, повторіть нанесення суміші (Фарба+Оксид 1:1) без шампуню.</div>",
                ...
                phase2.steps.push({
                    ...
                    details: "Нанести на вологе волосся.<div class='tech-note'>⚡ Технологічна нота:<br>🎨 ФІКСАЦІЯ КОЛЬОРУ: Після тонування використовувати ТІЛЬКИ кондиціонер з низьким pH. Маску НЕ використовувати (вона вимиває пігмент).</div>",
            ...
            if (finalLength && finalLength.process === "Емульгація") {
                ...
                phase1.steps.push({ stepName: "Довжина", action: `Пудра + ${finalLength.ox} (Пропорція ${finalLength.ratio})`, details: `Маса пудри: ${massDist.length} гр<div class='tech-note'>⚡ Технологічна нота:<br>⚠️ СВІЖІСТЬ СУМІШІ: Пудра активна 30-40 хв. Готуйте суміш окремо для кожної зони голови (мінімум 4 заміси).<br>⚠️ ТОВЩИНА ПАСОМ: Працюйте тонким зрізом до 1 см.</div>`, reason: "Освітлення / Видалення косметичного пігменту" });
            }
            ...
            phase1.steps.push({ stepName: "Візуальний контроль", action: "Змити ШГО + маска", details: "Змиття після досягнення ФО<div class='tech-note'>🧼 ЕТАП ОЧИЩЕННЯ: Змити пудру ШГО (2 рази). Обов'язково нанести ліпідну маску на 5 хв для наповнення структури ПЕРЕД тонуванням.</div>", reason: "Зупинка лужної реакції персульфатів" });
            phases.push(phase1);
            ...
            if (isCoolBlonde && inputSnapshot.condition === HairCondition.POROUS) {
                ...
                phase2.steps.push({ stepName: "Тонування", action: toningRecipe, details: "Пропорція 1:2 на вологе<div class='tech-note'>⚡ Технологічна нота:<br>🎨 ФІКСАЦІЯ КОЛЬОРУ: Після тонування використовувати ТІЛЬКИ кондиціонер з низьким pH. Маску НЕ використовувати (вона вимиває пігмент).</div>", reason: "Нейтралізація ФО" });
            }
            phases.push(phase2);
